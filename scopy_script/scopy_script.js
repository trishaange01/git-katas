/*** Create a script to set the output voltage of signal generator channel 1 
 to 2Vpp sinewave. Capture this signal on oscilloscope channel 2. ***/
...
function set_signal_generator(){
	...
	/* Set Channel 1 amplitude to 2V */
	siggen.waveform_amplitude[0] = 1
	
	/* Set Channel 1 offset to 1V */
	siggen.waveform_offset[0] = 0.5
